...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gameActions = __webpack_require__(8);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var checkWin = function checkWin() {
	  var boxOne = $('#box-1').text();
	  var boxTwo = $('#box-2').text();
	  var boxThree = $('#box-3').text();
	  var boxFour = $('#box-4').text();
	  var boxFive = $('#box-5').text();
	  var boxSix = $('#box-6').text();
	  var boxSeven = $('#box-7').text();
	  var boxEight = $('#box-8').text();
	  var boxNine = $('#box-9').text();
	...
	var oneArray = ['Player 1, look at the Game Count above me. Think of all the minutes youve wasted...', 'Player 1, I just got a call from your mother. She is disappointed in that last move.', 'I am sorry for the insults Player 1. Its just been a long day and, well, you deserve them.', 'Player 1, can I get you anything? Soda, tea, a Tic-Tac-Toe guide for Dummies?', 'Wow, Player 1. That last move was pretty good. Player 2, get your game together.', 'Player 1, I changed my mind. You are great at this. Quit your day job. Pursue this professionally. You will not regret it...'];
	// Random response Player 2 array
	var twoArray = ['Player 2, I believe in you as a tic-tac-toe player and as a person.', 'Player 2, if you start to lose, just accidentally hit the New Game button.', 'Player 2, that was a nice move.', 'Player 2, thats right. YOU ARE DOING SO WELL!', 'I am going to take a nap. Player 2, will you wake me when you win?'];
	var getRandomSentenceForOne = function getRandomSentenceForOne() {
	  var index = Math.floor(Math.random() * (oneArray.length - 1));
	  var oneReply = oneArray[index];
	  $('#robotText').text(oneReply);
	};
	var getRandomSentenceForTwo = function getRandomSentenceForTwo() {
	  var index = Math.floor(Math.random() * (twoArray.length - 1));
	  var twoReply = twoArray[index];
	  $('#robotText').text(twoReply);
	};

	// Below is the logic for the game-text, which is also linked to the game-text
	var turnLogic = function turnLogic(event) {
	  if (turnCounter % 2 === 0) {
	...
	var getNewGame = function getNewGame(event) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(6);
	var save = __webpack_require__(10);
	...
	var gameUpdates = function gameUpdates(data) {
	  return $.ajax({
	...
	var getGameUpdates = function getGameUpdates() {
	  ...
	  var currIndex = $('.game').index(event.target);
	  ...
	  gameUpdates(data).then(function (data) {}).catch(function (data) {});
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  changePassword(data).then(function (data) {
